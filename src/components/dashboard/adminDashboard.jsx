  ...
  return (
    <div className="min-h-screen p-6 md:p-16 flex flex-col bg-[#E0ECDE]">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center">
        ...
        <img
          className="w-full max-w-xs md:max-w-md mt-6 md:mt-0"
          src="./src/assets/admin-illustration.svg"
      ...
      <div className="flex justify-center mt-12">
        <button
          ...
          className="bg-[#2C6975] text-white px-6 py-2 rounded-xl shadow hover:bg-[#68B2A0] transition-all"
        >
